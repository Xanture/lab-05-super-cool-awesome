...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var answers = [];
  var sumnum = sum(a, b);
  sumnum = sum(sumnum[0], c);
  var prodnum = multiply(a, b);
  prodnum = multiply(prodnum[0], c);
  answers[0] = sumnum[0];
  answers[1] = prodnum[0];
  answers[2] = (a + ' and ' + b + ' and ' + c + ' sum to ' + sumnum[0] + '.')
  answers[3] = ('The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + prodnum[0] +'.')
  return answers
}
